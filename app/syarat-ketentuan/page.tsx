  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg)]">
      <div className="mx-auto max-w-2xl px-6 py-14 sm:py-20">
        ...
        <h2 className={sectionTitle}>2. Memasang Loker</h2>
        ...
        <h2 className={sectionTitle}>3. Moderasi & Hak Penolakan</h2>
        <p className={paragraph}>
        ...
        <h2 className={sectionTitle}>4. Masa Aktif Loker</h2>
        <p className={paragraph}>
        ...
        <h2 className={sectionTitle}>5. Batasan Tanggung Jawab</h2>
        <p className={paragraph}>
        ...
        <h2 className={sectionTitle}>6. Perubahan Layanan</h2>
        <p className={paragraph}>
        ...
        <h2 className={sectionTitle}>7. Hukum yang Berlaku</h2>
        <p className={paragraph}>
          Syarat & ketentuan ini tunduk pada dan ditafsirkan sesuai hukum yang berlaku di Republik
          Indonesia.
        </p>

        <h2 className={sectionTitle}>8. Kontak</h2>
        <p className={paragraph}>
